...
import { StyleSheet, View, Button, SafeAreaView, Image, Text, TouchableOpacity, Platform, StatusBar, Dimensions } from "react-native";
  ...
  signInWithGoogleAsync = async () => {
    try {
      const result = await Google.logInAsync({
        behaviour: "web",
        androidClientId:
          "338053699293-1r6qvkq7q9gftbnocc190ac0jnl8rj10.apps.googleusercontent.com",
        iosClientId:
          "338053699293-5of5lqs1e2cvicmqprnhvo95l6eln9hi.apps.googleusercontent.com",
      ...
      return (
        <View style={styles.container}>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.button} onPress={()=> this.props.navigation.navigate("DashboardScreen")}>
